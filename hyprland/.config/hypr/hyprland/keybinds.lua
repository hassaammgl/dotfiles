...
hl.bind("SUPER + F7", hl.dsp.exec_cmd("swayosd-client --brightness raise"), { locked = true, repeating = true })
hl.bind("SUPER + F6", hl.dsp.exec_cmd("swayosd-client --brightness lower"), { locked = true, repeating = true })
...
hl.bind("SUPER + SHIFT + M",    hl.dsp.exec_cmd("swayosd-client --output-volume mute-toggle"), { locked = true })
hl.bind("XF86AudioRaiseVolume", hl.dsp.exec_cmd("swayosd-client --output-volume +" .. volumeStep), { locked = true, repeating = true })
hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("swayosd-client --output-volume -" .. volumeStep), { locked = true, repeating = true })
hl.bind("SUPER + F3", hl.dsp.exec_cmd("swayosd-client --output-volume +" .. volumeStep), { locked = true, repeating = true })
hl.bind("SUPER + F2", hl.dsp.exec_cmd("swayosd-client --output-volume -" .. volumeStep), { locked = true, repeating = true })
hl.bind("SUPER + F1", hl.dsp.exec_cmd("swayosd-client --output-volume mute-toggle"), { locked = true })
