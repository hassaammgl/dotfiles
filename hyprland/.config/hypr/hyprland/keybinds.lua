...
hl.bind("SUPER + F6", hl.dsp.exec_cmd("~/.config/hypr/scripts/brightness.sh lower"), { locked = true, repeating = true })
...
hl.bind("SUPER + SHIFT + M",    hl.dsp.exec_cmd("~/.config/hypr/scripts/volume.sh mute"), { locked = true })
...
hl.bind("SUPER + F3", hl.dsp.exec_cmd("~/.config/hypr/scripts/volume.sh raise"), { locked = true, repeating = true })
hl.bind("SUPER + F2", hl.dsp.exec_cmd("~/.config/hypr/scripts/volume.sh lower"), { locked = true, repeating = true })
hl.bind("SUPER + F1", hl.dsp.exec_cmd("~/.config/hypr/scripts/volume.sh mute"), { locked = true })
